...
-- Product_Product [rel2]
create table "APP"."PRODUCT_PRODUCT" (
   "PRODUCT_OID"  integer not null,
   "PRODUCT_OID_2"  integer not null,
  primary key ("PRODUCT_OID", "PRODUCT_OID_2")
);
alter table "APP"."PRODUCT_PRODUCT"   add constraint FK_PRODUCT_PRODUCT_PRODUCT_2 foreign key ("PRODUCT_OID") references "APP"."PRODUCT" ("OID");
alter table "APP"."PRODUCT_PRODUCT"   add constraint FK_PRODUCT_PRODUCT_PRODUCT foreign key ("PRODUCT_OID_2") references "APP"."PRODUCT" ("OID");

	...
	(function ($) {
		...
		$.wysiwyg.controls.link = {
			init: function (Wysiwyg) {
				...
				formLinkHtml = '<form class="wysiwyg" title="' + formTextLegend + '">' + formTextUrl + ': <input type="text" name="linkhref" value=""><br/><br/>' + formTextTitle + ': <input type="text" name="linktitle" value=""><br/><br/>' + formTextTarget + ': <input type="text" name="linktarget" value=""><hr>' + '<button class="button" id="wysiwyg_submit">' + formTextSubmit + '</button> ' + '<button class="button" id="wysiwyg_reset">' + formTextReset + '</button></form>';
				...
				dialog.dialog({
                  ...
                  if ($.dialog) {
                    ...
                    alert(Wysiwyg.options.messages.nonSelection);
                  }
								}
							}
